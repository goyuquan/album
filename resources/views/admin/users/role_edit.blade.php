    ...
    <div id="content">
        ...
        <div class="row">
            <article class="col-md-12">
                ...
                <div class="jarviswidget jarviswidget-color-greenDark" id="wid-id-64948618" data-widget-colorbutton="false" data-widget-editbutton="false">
                                    ...
                                    <form id="role_form" method="POST" action="/admin/user/role/{{$role->id}}/update" >
                                        ...
                                        <div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-left">
                                            ...
                                            <button class="btn btn-danger">
                                                <i class="fa fa-edit"></i> <span class="hidden-mobile">修改</span>
                                            </button>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-xs hidden-sm">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="/admin/user/role/{{ $role->id }}/destroy"> <i class="fa fa-times" style="font-size:24px;"></i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
...
$(function(){
    ...
    var $creat_form = $("#role-form").validate({//表单验证
